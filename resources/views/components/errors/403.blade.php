...
<head>
    ...
    <!--build:css-->
    <link rel="stylesheet" href="https://tepad.id/assets/quiety/css/main.css">
    <!-- endbuild -->

    <!--custom css start-->
    <link rel="stylesheet" href="https://tepad.id/assets/quiety/css/custom.css">
    <!--custom css end-->
</head>
...
<body>
    ...
    <div class="main-wrapper">
        ...
        <section
            ...
            style="background: url('https://tepad.id/assets//img/page-header-bg.svg')no-repeat bottom right">
