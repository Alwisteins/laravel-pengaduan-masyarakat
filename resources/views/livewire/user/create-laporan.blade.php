@section('title', 'Form Laporan Baru')
<div>
    ...
    <div class="col-md-12 col-12">
        <div class="card">
            <div class="card-header text-center">
                <h4 class="card-title">Form Laporan Baru</h4>
            </div>
                                    ...
                                    <div class="form-group has-icon-left">
                                        ...
                                        <div class="position-relative">
                                            <textarea id="deskripsi" wire:model="deskripsi" rows="5"
                                                class="form-control @error('deskripsi') is-invalid @enderror" placeholder="Tuliskan deskripsi laporan"></textarea>
                                            <div class="form-control-icon">
                                ...
                                <div class="col-12">
                                    <div class="form-group">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <input type="file" id="gambar" accept="image/*" wire:model="gambar"
